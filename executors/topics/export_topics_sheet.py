...
def build_rows(topics: list[dict]) -> list[list]:
    """Build header + data rows for the 14-column topic analysis layout."""
    header = [
        "#",                    # 1  - Rank
        "Topic",                # 2
        ...
        "Source Strength",      # 14 - Multi (3+) / Dual / Single
    ]
    rows = [header]
...
def apply_formatting(service, spreadsheet_id: str, tab_id: int,
    ...
    # Source Strength(100)
    col_widths = [50, 250, 70, 80, 80, 80, 300, 250, 300, 100, 350, 250, 100, 100]
...
def main():
    ...
    parser.add_argument("--input", required=True,
                        help="Path to topics_analysis.json (scored topic list)")
